use boxddd::{
    ...
    Vec3, clip_vector, collide_capsule_and_sphere, collide_triangle_and_capsule, collide_capsules,
    collide_hull_and_capsule, collide_hull_and_sphere, collide_triangle_and_hull, collide_hulls,
    collide_triangle_and_sphere, collide_spheres, get_sweep_transform, ray_cast_capsule,
...
fn missing_collision_pairs_return_owned_manifolds() {
    ...
    assert!(
        !collide_triangle_and_hull(triangle, 0, &hull_a)
            .unwrap()
            .points
            .is_empty()
    );
